...
class ModifyDoneOrderScreen extends StatefulWidget {
  ...
  const ModifyDoneOrderScreen({super.key, this.order, required this.pageIndex});

  @override
  State<ModifyDoneOrderScreen> createState() => _ModifyDoneOrderScreenState();
}

class _ModifyDoneOrderScreenState extends State<ModifyDoneOrderScreen> {
